...
# coupling_idxs = [[1:12,13:16]]
# p = initialize_prob_multiple(Float64, energies, freqs, sats, pols, beam_radius, d, m/(ħ*k^2/Γ), Γ, k, sim_params, update_p!, add_terms_dψ!, 16, 4, coupling_idxs)
# p = initialize_prob_multiple(Float64, energies, freqs, sats, pols, beam_radius, d, m/(ħ*k^2/Γ), Γ, k, sim_params, update_p!, add_terms_dψ!, 12, 4, coupling_idxs)
...
# p_diffusion = initialize_prob(Float64, energies, freqs, sats, pols, beam_radius, d, m/(ħ*k^2/Γ), Γ, k, sim_params, update_p_diffusion!, add_terms_dψ!, 16, 4)
